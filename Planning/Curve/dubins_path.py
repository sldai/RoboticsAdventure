"""
Dubins curve implementation.
Ref: https://github.com/sldai/RoboticsAdventure/blob/master/Planning/Curve/reeds_shepp.py
"""
...
def M(theta):
    """
    Return the angle phi = theta mod (2 pi) such that 0 <= theta < 2*pi.
    """
